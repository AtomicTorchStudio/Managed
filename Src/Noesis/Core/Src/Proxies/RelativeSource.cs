...
public class RelativeSource : MarkupExtension {
  ...
  public RelativeSource(RelativeSourceMode mode, Type type, int level) : this(NoesisGUI_PINVOKE.new_RelativeSource__SWIG_2((int)mode, type != null ? Noesis.Extend.GetNativeType(type) : IntPtr.Zero, level), true) {
  }
  ...
  public Type AncestorType {
    set {
      NoesisGUI_PINVOKE.RelativeSource_AncestorType_set(swigCPtr, value != null ? Noesis.Extend.GetNativeType(value) : IntPtr.Zero);
    }
    get {
